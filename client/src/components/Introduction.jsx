...
export function Introduction() {
  return (
    <section className="container mx-auto px-4 py-20">
      <motion.h1 className='text-center text-6xl font-extrabold mb-8 text-white'
        initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}>
        Welcome to Aalok
      </motion.h1>
      <motion.div
        className="max-w-4xl mx-auto text-center text-white space-y-6 rounded-xl p-8 ring-1 ring-slate-800 bg-slate-900/90"
      ...
      >
        <motion.p className="text-2xl leading-relaxed" variants={fadeInUp} initial="initial" animate="animate" transition={fadeInUp.transition}>
          Aalok is an AI-driven system to detect similarities in Expressions of Interest (EoIs) submitted by vendors.
        </motion.p>
